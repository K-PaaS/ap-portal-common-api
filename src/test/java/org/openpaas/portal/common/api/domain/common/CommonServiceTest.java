package org.openpaas.portal.common.api.domain.common;
...
public class CommonServiceTest {
    ...
    @Value("${ap.portal.api.authorization.base64}")
    private String base64Authorization;

    @Value("${ap.portal.api.zuulUrl.cfapi}")
    private String cfApiUrl;

    @Value("${ap.portal.api.zuulUrl.commonapi}")
    private String commonApiUrl;

    @Value("${ap.portal.api.zuulUrl.storageapi}")
    private String storageApiUrl;

    @Value("${ap.portal.storageapi.type}")
