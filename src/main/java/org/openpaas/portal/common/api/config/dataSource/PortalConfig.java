package org.openpaas.portal.common.api.config.dataSource;
...
@EnableJpaRepositories(
        basePackages = "org.openpaas.portal.common.api.repository.portal",
...
public class PortalConfig {
    ...
    public LocalContainerEntityManagerFactoryBean portalEntityManager() {
        ...
        em.setPackagesToScan(new String[] { "org.openpaas.portal.common.api.entity.portal" });
