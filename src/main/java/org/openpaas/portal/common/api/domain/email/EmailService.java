package org.openpaas.portal.common.api.domain.email;
...
import org.openpaas.portal.common.api.config.EmailConfig;
import org.openpaas.portal.common.api.config.LanguageConfig;
...
public class EmailService {
    ...
    public Map inviteOrgEmailSend(String userId, String orgName, String refreshToken, String useLang) {
        ...
        try {
            ...
            final Elements elementSpanId = doc.select( "span[id=ap_id]" );
            if (elementSpanId.size() >= 0) {
                logger.info("invite user id : {}", userId);
                elementSpanId.get( 0 ).text( userId );
            }

            final Elements elementSpanOrg = doc.select( "span[id=ap_org]" );
